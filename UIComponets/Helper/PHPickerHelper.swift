...
class PHPickerHelper {
    ...
    static let shared = PHPickerHelper()
    ...
    func pick(_ sender: UIViewController, imageCompletionHandler: @escaping (_ image: UIImage) -> Void, videoCompletionHandler: ((_ url: URL) -> UIViewController?)?) {
